...
Source0  : https://cpan.metacpan.org/authors/id/I/IS/ISHIGAKI/DBD-SQLite-1.68.tar.gz
...
%prep
%setup -q -n DBD-SQLite-1.68
cd %{_builddir}/DBD-SQLite-1.68
%patch1 -p1
...
cp %{_builddir}/DBD-SQLite-1.68/LICENSE %{buildroot}/usr/share/package-licenses/perl-DBD-SQLite/ac65ff6b8120c21db8e28bbfbf89a2da90009f97
if test -f Makefile.PL; then
